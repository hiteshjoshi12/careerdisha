          ...
          {admissionOptions.map((option, index) => (
            ...
            >
              ...
              <Link to={option.link} className="mt-auto">
                <button className="flex cursor-pointer items-center gap-2 bg-[#1a1a1a] hover:bg-orange-600 text-orange-500 hover:text-white border border-gray-800 hover:border-orange-500 px-6 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0)] hover:shadow-[0_0_20px_rgba(234,88,12,0.4)]">
