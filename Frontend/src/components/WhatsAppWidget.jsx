  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3 pointer-events-none">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        // We use WhatsApp's brand green here, but add a dark-theme compatible glow
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] transition-shadow pointer-events-auto group"
      >
